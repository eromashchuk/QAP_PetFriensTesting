...
class TestCasesPositive:
    ...
    def test_get_all_pets_with_valid_key(self, auth_key, filter=''):
    ...
    @pytest.mark.student
    def test_successful_create_pet_simple(self, auth_key, name='Myrchik', animal_type='Sckotina',
                                          age='2'):
...
class TestCasesNegative:
    ...
    def test_error_400_for_updating_not_existing_pet(self, auth_key, pet_id="0123456123456j", name='', animal_type='', age=''):
